...
let frase: string = "Aprendendo TypeScript com o Professor Manzano";
let palavras: string = new Array(4).fill(new Array(10).fill(''));
...
let palavrasEncontradas: string = frase.split(" ", 4);
...
process.stdout.write("A palavra 'TypeScript' na posicao: ");
console.log(frase.indexOf("TypeScript") + 1);
console.log("");
